...
function TestMapPage(props) {
  return (
    ...
    <div class="embed-container"><iframe width="100%" height="100%" scrolling="no" marginheight="0" marginwidth="0" title="TestMap" src="https://www.arcgis.com/apps/dashboards/013c22ff2c2141c4b0543a5252883907"></iframe></div>
  );
}
