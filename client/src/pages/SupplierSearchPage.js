...
import { Box, Autocomplete, Pagination, TablePagination, TextField } from '@mui/material'
    ...
    <div>
      ...
      <Box sx={{ width: '100%', typography: 'body1' }}>
        <Form>
          ...
          <div style={{ width: '100%' }}>
            <Label for="supplier_name" sm={2} style={inputLabelStyle}>Supplier Name</Label>
            <Col sm={10}>
            ...
            <Label for="order_period" sm={2} style={inputLabelStyle}>Order Period</Label>
            <Col sm={10}>
